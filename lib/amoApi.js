...
async function getAccessToken() {
  ...
  // 1. Сначала читаем client_id, client_secret, refresh_token из таблицы SystemSetting
  // 2. Только если их нет - берем из process.env (реализовано внутри getAmoCredentialsFromDb)
