...
async function getAccessToken() {
  ...
  console.log('  client_secret:', process.env.AMO_CLIENT_SECRET ? '***' + process.env.AMO_CLIENT_SECRET.slice(-4) : 'NOT SET');
  console.log('  refresh_token:', currentRefreshToken ? '***' + currentRefreshToken.slice(-10) : 'NOT SET');
  console.log('  redirect_uri:', process.env.AMO_REDIRECT_URI || 'NOT SET (undefined)');
