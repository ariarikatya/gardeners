  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-lg border border-slate-200 p-6 text-center space-y-4">
        ...
        <h1 className="text-xl font-bold text-slate-800">Произошла ошибка</h1>
        <p className="text-sm text-slate-600 leading-relaxed">
          К сожалению, возникла проблема при загрузке страницы. Попробуйте обновить страницу или очистить кэш приложения.
        </p>
